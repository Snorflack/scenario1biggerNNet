...
import azg
from azg import MCTS


default_neural_net_dir = "/home/joseph.coble/Thesis/Thesis/scenario1/server/azg/temp"
action_count = 0
...
class AI:
    ...
    def __init__(self, role, kwargs):
        ...
        scenario_name = AI.args["scenario_name"]
        self.astar_game = alphazero_game.AtlatlGame(scenario_name)
        ...
        self.nmcts = MCTS.MCTS(self.astar_game, nnet, AI.args)
