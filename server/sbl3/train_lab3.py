...
env = gym_interface.GymEnvironment(role="blue", versusAI="pass-agg", scenario="city-inf-5", saveReplay=False, actions19=False, ai="gym14", verbose=False, scenarioSeed=4025, scenarioCycle=1)
