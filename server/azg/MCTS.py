...
class MCTS():
    ...
    def clear(self): #added to reset mcts tree
        self.Qsa = {}
        self.Nsa = {}
        self.Ns = {}
        self.Ps = {}
    ...
    def getActionProb(self, canonicalBoard, temp=1):
        ...
        # # Add a print statement to visualize the action probabilities
        # print("Action probabilities:")
        # for i, count in enumerate(counts):
        #     print(f"Action {i}: Probability {count}")
    ...
    def search(self, actualBoard):
        ...
        # # Add a print statement to visualize the canonical board
        ...
        if verbose:
            actionPo = self.game.vectorIndexActionToAtlatl(a, canonicalBoard)
            print(f'searching child with action {actionPo} index {a}')
