...
class Coach():
    ...
    def __init__(self, game, nnet, args):
        ...
        self.skipFirstSelfPlay = False  # can be overriden in loadTrainExamples() changed to true from false troubleshooting back to false
    ...
    def learn(self):
        ...
        for i in range(1, self.args.numIters + 1):
            ...
            self.nnet.train(trainExamples, writer=self.writer)
            # # Log the training loss
            # self.writer.add_scalar("Loss/train", self.nnet.loss, i)
            ...
            self.writer.add_scalar(
                f'Win Rate vs Previous Model', (nwins)/self.args.arenaCompare, i)
            # print(f'wins: {pwins}, ties: {draws}, losses:{nwins}\n')
            self.writer.close()
