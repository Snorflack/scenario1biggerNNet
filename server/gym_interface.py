...
class Args:
    def __init__(self, scenario="plain2v1.scn", v=False, blueAI="passive", redAI="passive", blueNeuralNet=None, redNeuralNet=None, blueReplay=None, redReplay=None, openSocket=False, scenarioSeed=None, scenarioCycle=0, nReps=0):
